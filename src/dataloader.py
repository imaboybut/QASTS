...
class AudiosetDataset(Dataset):
    def __init__(self, dataset_json_file, audio_conf, label_csv=None):
        ...
        self.target_sample_rate = self.audio_conf.get('sample_rate', None)
        if self.target_sample_rate:
            print('Target sample rate: {:d} Hz'.format(self.target_sample_rate))
        else:
            print('Using original sample rate (no resampling)')

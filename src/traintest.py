...
def train(audio_model, train_loader, test_loader, args):
    ...
    while epoch < args.n_epochs + 1:
        ...
        # DISABLED: best model and optimizer saving
        # if best_epoch == epoch:
    ...
    torch.save(audio_model.state_dict(), "%s/models/final_audio_model.pth" % (exp_dir))
    print(f"Final model saved to {exp_dir}/models/final_audio_model.pth")

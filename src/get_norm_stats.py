...
# Sample code to compute normalization stats for input spectrogram.
...
# Set skip_norm=True only when computing normalization stats.
audio_conf = {'num_mel_bins': 128, 'target_length': 1024, 'freqm': 24, 'timem': 192, 'mixup': 0.5, 'skip_norm': True, 'mode': 'train', 'dataset': 'audioset'}

# Update these paths for your local dataset layout.
data_json = './data/datafiles/balanced_train_data.json'

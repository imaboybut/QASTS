...
try:
    ...
    # from timm.layers import named_apply
    from timm.models.layers.weight_init import trunc_normal_ , lecun_normal_
    from timm.models.layers.helpers import to_2tuple
    from timm.models.layers.drop import DropPath
    from timm.models.vision_transformer import PatchEmbed
except ImportError:
    # Fallback values if timm is not available
    IMAGENET_DEFAULT_MEAN = (0.485, 0.456, 0.406)
    IMAGENET_DEFAULT_STD = (0.229, 0.224, 0.225)
    IMAGENET_INCEPTION_MEAN = (0.5, 0.5, 0.5)
    IMAGENET_INCEPTION_STD = (0.5, 0.5, 0.5)
    
    # Basic implementations for missing timm functions
...
class Block(nn.Module):
    ...
    def forward(self, x):            
        if self.qqkkvv:
            ...
            print(f"\n[DEBUG Block] Input x device: {x.device}")
